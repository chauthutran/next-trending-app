...
const colors = [
    "text-[#E63946]",  // Crimson Red
    "text-[#F4A261]",  // Sandy Orange
    "text-[#E9C46A]",  // Golden Yellow
    "text-[#2A9D8F]",  // Turquoise Green
    "text-[#457B9D]",  // Steel Blue
    "text-[#9B5DE5]",  // Vibrant Purple
];
    ...
    return (
        ...
        <header className="relative px-5 py-2 grid grid-cols-2 text-sm text-electric-blue bg-white">
            ...
            <div className="flex items-center font-extrabold">
                ...
                {/* {"World Trending".split("").map((char, index) => (
                    <span key={index} className={`text-2xl bg-lemon-zes`}>
                    {char}
                </span>
                ))} */}
